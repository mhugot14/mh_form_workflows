...
$main_title = $is_vollzeit ? 'Ergebnisprotokoll der Zeugniskonferenz Vollzeit' : 'Ergebnisprotokoll der Zeugniskonferenz Berufsschule';

$subtitle = 'Zeugnis'; 
if ( isset($data['certificate']) && $data['certificate'] === 'ueberweisung' ) $subtitle = 'Überweisungszeugnis';
...
<div style="text-align: right; font-size: 10pt; margin-bottom: 10px;">Seite 1 (Protokoll)</div>
...
<!-- Stammdaten Tabelle (inkl. Fehlstunden) -->
<table class="no-border" style="width:100%; margin-bottom: 15px;">
    ...
    <!-- HIER SIND JETZT DIE FEHLSTUNDEN -->
    <tr>
        <td class="no-border" colspan="2" style="border-bottom:1px dashed #ccc; padding-bottom:10px; padding-top:10px;">
            <b>Fehlstunden Gesamt:</b> <?= $esc('missed_hours') ?> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b>davon unentschuldigt:</b> <?= $esc('missed_ue') ?>
        </td>
    </tr>
